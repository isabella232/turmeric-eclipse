...
public class ServiceFromWsdlParamModel extends BaseServiceParamModel {
	...
	/**
	 * Sets the status of type folding. Probably better refactoring
	 * enableTypeFolding() disableTypeFolding().
	 * 
	 * @param typeFolding
	 *            true or false if type folding should be enabled or not.
	 */
	...
	/**
	 * 
	 * @param baseConsumerDir
	 *            the base consumer source directory.
	 */
	...
	/**
	 * 
	 * @param overrideWorkspaceRoot
	 *            true or false to enable/disable the workspace root override.
	 */
	...
	/**
	 * 
	 * @param interfaceProjects
	 *            a set of interface projects
	 */
	 ...
	 * 
	 * @param implLibs
	 *            a Set of implementation libraries
	 */
	 ...
	 * 
	 * @param implProjects
	 *            a Set of implemenation projects
	 */
	...
	/**
	 * 
	 * @param originalWsdlUrl
	 *            URL location of the original wsdl.
	 */
	...
	/**
	 * 
	 * @param namespaceToPacakgeMappings
	 *            A Map containing the namespace to java package names
	 */
