...
/**
 * The Class SubmitNewServiceVersion.
 *
 * @author yayu
 * @since 1.0.0
 */
public class SubmitNewServiceVersion extends AbstractSubmitAssetAction {
	private static final SOALogger logger = SOALogger.getLogger();
	
	/**
	 * Instantiates a new submit new service version.
	 */
	public SubmitNewServiceVersion() {
		super();
	}
	...
	public IStatus submitAsset(IAction action, IProject project)
			throws Exception {
		IStatus result = ActionUtil.submitNewVersionAssetToSOARegistry(project, null);
		if (result.isOK()) {
