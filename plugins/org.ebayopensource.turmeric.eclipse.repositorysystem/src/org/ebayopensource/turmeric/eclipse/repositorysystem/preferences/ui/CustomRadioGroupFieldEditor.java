...
public class CustomRadioGroupFieldEditor extends FieldEditor {
    ...
    protected void doLoad() {
        ...
        updateSubValue(value, getPreferenceStore().getString(
                getSubPreferenceName()));
    }
    ...
    protected void doLoadDefault() {
        String value = getPreferenceStore().getDefaultString(
                getPreferenceName());
        updateValue(value);
        updateSubValue(value, getPreferenceStore().getDefaultString(
                getSubPreferenceName()));
    }
    ...
    public Composite getRadioBoxControl(Composite parent) {
        ...
        for (int i = 0; i < labelsAndValues.length; i++) {
            ...
            if (fieldEditor != null) {
                ...
                fieldEditor.setEnabled(radio.getText().equals(
    ...
    private void setSubFieldEditorEnabled(boolean enabled) {
        for (FieldEditor fieldEditor : this.subFieldEditors.keySet()) {
            fieldEditor.setEnabled(enabled, this.subFieldEditors
                    .get(fieldEditor));
        }
    }
