...
package org.ebayopensource.turmeric.blogs.v1.services.calcservice.gen;
...
import org.ebayopensource.turmeric.blogs.v1.services.calcservice.AsyncBlogsCalcServiceV1;
 ...
 * 
 */
public class SharedBlogsCalcServiceV1Consumer
    implements AsyncBlogsCalcServiceV1
{

    private URL m_serviceLocation = null;
    private final static String SVC_ADMIN_NAME = "BlogsCalcServiceV1";
    private String m_clientName;
    private String m_environment = "production";
    private AsyncBlogsCalcServiceV1 m_proxy = null;
    private String m_authToken = null;
    private Cookie[] m_cookies;
    private Service m_service = null;

    public SharedBlogsCalcServiceV1Consumer(String clientName)
    ...
    public SharedBlogsCalcServiceV1Consumer(String clientName, String environment)
        throws ServiceException
    {
        if (environment == null) {
    ...
    protected AsyncBlogsCalcServiceV1 getProxy()
        throws ServiceException
    {
        m_service = getService();
