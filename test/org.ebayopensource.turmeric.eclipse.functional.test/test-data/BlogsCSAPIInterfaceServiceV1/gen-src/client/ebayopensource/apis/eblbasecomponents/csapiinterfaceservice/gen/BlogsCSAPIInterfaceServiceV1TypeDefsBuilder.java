    ...
    extends BaseTypeDefsBuilder
{
    ...
    private void addComplexTypes0(ArrayList<FlatSchemaComplexTypeImpl> complexTypes) {
        // Type #0 (DuplicateInvocationDetailsType)
        ...
        // Type #14 (XMLRequesterCredentialsType)
    ...
    private void addComplexTypeElements0(ArrayList<FlatSchemaComplexTypeImpl> complexTypes) {
        ...
        currType.addComplexElement(new QName(NS1, "Credentials"), complexTypes.get(12), 1);
        ...
        currType.addComplexElement(new QName(NS1, "RequesterCredentials"), complexTypes.get(14), 1);
        ...
        currType.addComplexElement(new QName(NS1, "BotBlock"), complexTypes.get(8), 1);
        currType.addSimpleElement(new QName(NS1, "MachineGroupID"), 1);
        currType.addSimpleElement(new QName(NS1, "MachineGroupValue"), 1);
        currType.addComplexElement(new QName(NS1, "MachineTagTypes"), complexTypes.get(11), 1);
        ...
        currType.addSimpleElement(new QName(NS1, "MachineGroupValue"), 1);
        currType.addComplexElement(new QName(NS1, "MachineTagTypes"), complexTypes.get(11), 1);
        currType.addComplexElement(new QName(NS1, "User"), complexTypes.get(4), 1);
        currType.addSimpleElement(new QName(NS1, "ActivityID"), 1);
        currType.addComplexElement(new QName(NS1, "Attachment"), complexTypes.get(7), 1);
        ...
        currType.addComplexElement(new QName(NS1, "Errors"), complexTypes.get(1), -1);
        ...
        currType.addComplexElement(new QName(NS1, "DuplicateInvocationDetails"), complexTypes.get(0), 1);
        currType.addSimpleElement(new QName(NS1, "RecipientUserID"), 1);
        currType.addSimpleElement(new QName(NS1, "EIASToken"), 1);
        currType.addSimpleElement(new QName(NS1, "NotificationSignature"), 1);
        currType.addSimpleElement(new QName(NS1, "HardExpirationWarning"), 1);
        currType.addComplexElement(new QName(NS1, "BotBlock"), complexTypes.get(2), 1);
    ...
    private void addRootElements0(ArrayList<FlatSchemaComplexTypeImpl> complexTypes, HashMap<QName, FlatSchemaElementDeclImpl> rootElements) {
        rootElements.put(new QName(NS1, "RequesterCredentials"), FlatSchemaElementDeclImpl.createRootComplexElement(new QName(NS1, "RequesterCredentials"), complexTypes.get(3)));
        rootElements.put(new QName(NS1, "CSUpdateMACActivityAddAttachmentsResponse"), FlatSchemaElementDeclImpl.createRootComplexElement(new QName(NS1, "CSUpdateMACActivityAddAttachmentsResponse"), complexTypes.get(10)));
        rootElements.put(new QName(NS1, "CSUpdateMACActivityAddAttachmentsRequest"), FlatSchemaElementDeclImpl.createRootComplexElement(new QName(NS1, "CSUpdateMACActivityAddAttachmentsRequest"), complexTypes.get(6)));
    }
