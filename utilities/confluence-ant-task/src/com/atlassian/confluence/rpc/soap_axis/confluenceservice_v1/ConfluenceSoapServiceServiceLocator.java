...
public class ConfluenceSoapServiceServiceLocator extends org.apache.axis.client.Service implements
		com.atlassian.confluence.rpc.soap_axis.confluenceservice_v1.ConfluenceSoapServiceService {
	...
	public ConfluenceSoapServiceServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName)
			throws javax.xml.rpc.ServiceException {
		super(wsdlLoc, sName);
	}

	// Use to get a proxy class for ConfluenceserviceV1
	private java.lang.String ConfluenceserviceV1_address = "http://ph-0148.eva.ebay.com/wiki/rpc/soap-axis/confluenceservice-v1";
	...
	public com.atlassian.confluence.rpc.soap_axis.confluenceservice_v1.ConfluenceSoapService getConfluenceserviceV1(
		...
		try {
			com.atlassian.confluence.rpc.soap_axis.confluenceservice_v1.ConfluenceserviceV1SoapBindingStub _stub = new com.atlassian.confluence.rpc.soap_axis.confluenceservice_v1.ConfluenceserviceV1SoapBindingStub(
					portAddress, this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
		try {
			if (com.atlassian.confluence.rpc.soap_axis.confluenceservice_v1.ConfluenceSoapService.class.isAssignableFrom(serviceEndpointInterface)) {
				com.atlassian.confluence.rpc.soap_axis.confluenceservice_v1.ConfluenceserviceV1SoapBindingStub _stub = new com.atlassian.confluence.rpc.soap_axis.confluenceservice_v1.ConfluenceserviceV1SoapBindingStub(
						new java.net.URL(ConfluenceserviceV1_address), this);
				_stub.setPortName(getConfluenceserviceV1WSDDServiceName());
				return _stub;
			}
	...
	public javax.xml.namespace.QName getServiceName() {
		return new javax.xml.namespace.QName("http://ph-0148.eva.ebay.com/wiki/rpc/soap-axis/confluenceservice-v1",
	...
	public java.util.Iterator getPorts() {
		if (ports == null) {
			...
			ports.add(new javax.xml.namespace.QName(
					"http://ph-0148.eva.ebay.com/wiki/rpc/soap-axis/confluenceservice-v1", "confluenceservice-v1"));
		}
