...
public class RemoteServerInfo implements java.io.Serializable {
	...
	public RemoteServerInfo(java.lang.String baseUrl, java.lang.String buildId, boolean developmentBuild,
			int majorVersion, int minorVersion, int patchLevel) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = true
				...
				&& this.developmentBuild == other.isDevelopmentBuild() && this.majorVersion == other.getMajorVersion()
				&& this.minorVersion == other.getMinorVersion() && this.patchLevel == other.getPatchLevel();
		__equalsCalc = null;
		return _equals;
	}
