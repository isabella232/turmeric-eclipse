...
public class RemoteNodeStatus implements java.io.Serializable {
	...
	public RemoteNodeStatus(java.util.HashMap JVMstats, java.util.HashMap buildStats, int nodeId,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		boolean _equals;
		_equals = true
				&& ((this.JVMstats == null && other.getJVMstats() == null) || (this.JVMstats != null && this.JVMstats.equals(other.getJVMstats())))
				&& ((this.buildStats == null && other.getBuildStats() == null) || (this.buildStats != null && this.buildStats.equals(other.getBuildStats())))
				&& this.nodeId == other.getNodeId()
				&& ((this.props == null && other.getProps() == null) || (this.props != null && this.props.equals(other.getProps())));
		__equalsCalc = null;
		return _equals;
	}
